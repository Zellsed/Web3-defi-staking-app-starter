...
class Airdrop extends Component {
    ...
    airdropRewardTokens() {
        ...
        if (stakingB >= Web3.utils.fromWei('500000000000000000000', 'ether')) {
            this.startTimer();
        }
    }
    ...
    async issueTokens() {
        try {
            const result = await this.props.decentralBank.methods.issueTokens().send({ from: this.props.account });
